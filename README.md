...
Mô hình XGBoost đạt được độ chính xác cao nhất trong việc phát hiện website lừa đảo lên tới 86,4%. File model đã được lưu sẵn để sử dụng trực tiếp mà không cần huấn luyện lại. mô hình được lưu vào tệp ' XGBoostClassifier.pickle.dat '
---
